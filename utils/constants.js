module.exports = {
    ...
    //need to add doc and excel
    ALLOWED_FILE_TYPES : ['image/jpeg', 'image/jpg', 'image/png', 'application/pdf', 'multipart/form-data'],
    COMMUNICATION_EMAIL_TYPE : ["BS", "PR"],
    SPOUSE_TYPE : ['HU','WI','FA', 'MO','FA-IL', 'MO-IL', 'BR', 'SI', 'SO', 'DA', 'SL'] 
}